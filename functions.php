...
if ( ! function_exists( 'loudcrate_setup' ) ) :
/**
...
function loudcrate_setup() {
	...
	register_nav_menus( array(
		'primary' => esc_html__( 'Primary Menu', 'loudcrate' ),
	) );
	...
	add_theme_support( 'custom-background', apply_filters( 'loudcrate_custom_background_args', array(
		'default-color' => 'ffffff',
		'default-image' => '',
	) ) );
}
endif; // loudcrate_setup
add_action( 'after_setup_theme', 'loudcrate_setup' );
 ...
 */
function loudcrate_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'loudcrate_content_width', 640 );
}
add_action( 'after_setup_theme', 'loudcrate_content_width', 0 );
...
function loudcrate_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'loudcrate' ),
		'id'            => 'sidebar-1',
		'description'   => '',
